...
const Recomendadas = () => {
  return (
    <div className="p-6">
        ...
        <div className="w-full h-2/5 bg-secondary rounded-b-lg">
        <p className="text-white text-bold text-xl px-4 p-2">Bali</p>
        <p className="text-white text-md px-4">La isla de los Dioses</p>
        ...
        <div className="w-full h-2/5 bg-secondary rounded-b-lg">
        <p className="text-white text-bold text-xl px-4 p-2">Europe</p>
        <p className="text-white text-md px-4">Mayor bloque comercial del mundo</p>
        ...
        <div className="w-full h-2/5 bg-secondary rounded-b-lg">
        <p className="text-white text-bold text-xl px-4 p-2">Los Ángeles</p>
        <p className="text-white text-md px-4">Caminar por Beverly Hills</p>
        ...
        <div className="w-full h-2/5 bg-secondary rounded-b-lg">
        <p className="text-white text-bold text-xl px-4 p-2">Seattle</p>
        <p className="text-white text-md px-4">La ciudad cosmopolita</p>
        ...
        <div className="w-full h-2/5 bg-secondary rounded-b-lg">
        <p className="text-white text-bold text-xl px-4 p-2">Sydney</p>
        <p className="text-white text-md px-4">La ciudad moderna</p>
