...
import sanFrancisco from '../assets/sanFranciscoDesktop.jpg'
...
const Home = () => {
  ...
  return (
    ...
    <div className="w-full h-full flex flex-col absolute space-y-48 py-4 items-center lg:space-y-0 lg:items-start lg:pt-32 lg:justify-start">
        ...
        <button className="w-48 mt-8 rounded-full text-lg font-semibold p-4 bg-white shadow-lg transition-all duration-500 ease-in-out hover:bg-primary hover:text-white transform hover:-translate-y-1 hover:scale-110 lg:ml-16 dark:bg-terciary dark:text-white ">
            Explorar
        </button>
    </div>
